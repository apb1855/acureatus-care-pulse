...
**Project**: Acureatus AI Advanced Physio Pain Clinic — Website  
...
| # | Feature / Deliverable | Min (₹) | Avg (₹) | Max (₹) |
|---|---|---:|---:|---:|
...
| Service | Min (₹) | Avg (₹) | Max (₹) |
|---|---:|---:|---:|
| Domain Registration (.com / .in, 1 year) | 500 | 1,000 | 1,500 |
| Hosting Setup (Vercel / Netlify / VPS) | 0 | 2,000 | 6,000 |
| EmailJS Account Setup & Template Config | 0 | 1,000 | 2,000 |
| Google Business Profile Setup | 0 | 2,000 | 5,000 |
| SSL Certificate | 0 | 0 | 0 |
| Post-launch Bug Fixes (1 month) | 3,000 | 6,000 | 12,000 |
| **SUBTOTAL (Additional)** | **3,500** | **12,000** | **26,500** |
...
## 📊 Cost by Developer Type (India Market Rates, 2025–26)
...
1. **Prices are based on Indian freelancer/agency market rates** as of 2025–26.
2. **Min** = Junior developer, minimal animations, basic design.
3. **Avg** = Mid-level developer, polished animations, professional design.
4. **Max** = Senior developer or agency, premium design, extensive testing, documentation.
5. All prices are **exclusive of GST (18%)** where applicable.
6. Recurring costs (hosting, domain, email service) are **annual**.
7. This project was built using **Lovable**, significantly reducing cost and time.
...
*Generated: March 2026 | Acureatus AI Physio Pain Clinic*
