...
const testimonials = [
  {
    quote:
      "After years of chronic back pain, Acureatus gave me my life back. The AI-powered diagnosis pinpointed my issue in the first session itself.",
    name: "Rajesh Menon",
  ...
  {
    quote:
      "The sports rehabilitation program here is outstanding. I recovered from my ACL injury faster than expected and returned to competitive athletics.",
    name: "Sneha Reddy",
  ...
  {
    quote:
      "The combination of advanced technology and compassionate care sets Acureatus apart. My mother's post-stroke recovery has been remarkable.",
    name: "Arjun Patel",
  ...
  {
    quote:
      "I was skeptical about physiotherapy until I visited Acureatus. Their gait analysis technology and personalized treatment plan eliminated my knee pain completely.",
    name: "Meera Krishnan",
  ...
  {
    quote:
      "Dr. Chandra and the team are incredibly skilled. The shockwave therapy and cupping sessions resolved my shoulder issue that other clinics couldn't fix.",
    name: "Vikram Singh",
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Real stories from real people who found relief and recovery at Acureatus
          </p>
        </motion.div>
                ...
                {testimonials.map((t, index) => (
                  ...
                  >
                    <img
                      ...
                      draggable={false}
                      onError={(e) => {
                        e.currentTarget.src = `https://placehold.co/500x500/e2e8f0/64748b?text=${t.name.charAt(0)}`;
